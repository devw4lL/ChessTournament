...
from src.models import Tournament, Players, Manager, RunTournaments, RunTournaments
...
class Controler:
    ...
    def resume_tournament(self):
        ...
        self.tourn.reload_tourn(self.menu.get_input('Entrer le numéro du tournoi à reprendre.', 'EXEMPLE:', '2'))
    ...
    def play_round(self):
        ...
        if len(self.tourn.current_tourn.rounds) == 0:  # 1er round
            ...
            self.menu.show_rounds("Lancement", self.const.round_name[len(self.tourn.current_tourn.rounds)])
            ...
            if self.tourn.current_tourn.rounds[-1][0][2]:  # 2éme round j'usqu'a nb_round
                ...
                self.menu.show_rounds("Attendre la fin", self.tourn.current_tourn.rounds[-1][0][0])
        else:
    ...
    def end_round(self):
        ...
        :return:
        """
        self.menu.show_rounds("Fin", self.const.round_name[len(self.tourn.current_tourn.rounds) - 1])
        self.tourn.update_round(finish=True)
        self.tourn.current_tourn.update_tournament()
        self.tourn.current_tourn.update_all_players()
        self.tourn.reload_players()
